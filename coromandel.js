...
function clickFunc() {
    ...
    const url = "/cdn-cgi/representative-ab-sec/enterprise/coromandel/bmsc";
    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
                ...
                setTimeout(error.bind(null, 'Verification request had a code ' + xhr.status + ' error.'));
            }
        }
    };
    ...
    function success() {
        ...
        setTimeout(post_msg.bind(null, JSON.stringify(tmp)));
    }
    function error(msg) {
        ctLoading.style.opacity = '0';
