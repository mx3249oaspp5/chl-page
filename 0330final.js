...
function clickFunc() {
    ...
    window._bmsc = {}
    const payload = {};
    payload['sensor_data'] = window._bmsc;
    const xhr = new XMLHttpRequest();
    const url = "/cdn-cgi/apollo-bm-opts/enterprise/bmsc";
    xhr.open("POST", url, true);
    xhr["timeout"] = 5000;
    xhr["ontimeout"] = function () {
        setTimeout(error.bind(null, 'Sensor data request timed out.'), 500);
    }
    ...
    function success() {
        ...
        let tmp = { 'code': '1001' }
        window.parent.postMessage(JSON.stringify(tmp))
    }
    function error(msg) {
        ctLoading.style.opacity = '0'
