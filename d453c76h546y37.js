...
onmessage = function fuckyou() {
    socket = new WebSocket('wss://cp-ws.casinoplus.top/websocket', "10000000-1000-4000-8000-100000000000".replace(/[018]/g, er => (+er ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> +er / 4).toString(16)));
